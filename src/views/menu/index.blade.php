...
<div class="imain">
    <div class="itop ">
        ...
        <div class="">
            <a class="badge badge-primary ajax_html tree_div_btn" data-href="/admin/menu/tree">树形</a>
        </div>
    </div>
                ...
                @if($res['list']->total())
                    @foreach($res['list'] as $v)
                        <ul class="table_tbody">
                            ...
                            <li>
                                <a class="badge badge-info ajax_html" data-href="/admin/menu/edit?id={{$v['id']}}">编辑</a>
                            </li>
                        </ul>
                    @endforeach
