...
<div class="imain">
    <div class="itop ">
        ...
        <div class="">
            <a class="badge badge-primary ajax_html show_all0_btn" data-href="/admin/msg/add">添加</a>
        </div>
    </div>
            ...
            <div class="table">
                ...
                @if($res['list']->total())
                    ...
                    <ul class="table_tbody">
                        ...
                        <li>
                            <a class="badge badge-info ajax_html" data-href="/admin/msg/edit?id={{$v['id']}}">编辑</a>
                        </li>
                    </ul>
                    @endforeach
