    ...
    public function index()
    {
        if(config('admin.init')){
            ...
            if(!$user){
                ...
                $data=[];
                $data[] =['id'=>1,'name' => '后台角色','pid'=>0,'is_leaf'=>0];
                $data[] =['id'=>2,'name' => '管理员','pid'=>1,'is_leaf'=>1];
                $data[] =['id'=>3,'name' => '前台用户组','pid'=>0,'is_leaf'=>0];
                $data[] =['id'=>4,'name' => 'LV0','pid'=>3,'is_leaf'=>1];
                $data[] =['id'=>5,'name' => 'LV1','pid'=>3,'is_leaf'=>1];
                $data[] =['id'=>6,'name' => 'LV2','pid'=>3,'is_leaf'=>1];
                $data[] =['id'=>7,'name' => 'LV3','pid'=>3,'is_leaf'=>1];
                $data[] =['id'=>8,'name' => 'LV4','pid'=>3,'is_leaf'=>1];
                $data[] =['id'=>9,'name' => 'LV5','pid'=>3,'is_leaf'=>1];
                $data[] =['id'=>10,'name' => 'LV6','pid'=>3,'is_leaf'=>1];
                $data[] =['id'=>11,'name' => 'LV7','pid'=>3,'is_leaf'=>1];
                $data[] =['id'=>12,'name' => 'LV8','pid'=>3,'is_leaf'=>1];
                $data[] =['id'=>13,'name' => 'LV9','pid'=>3,'is_leaf'=>1];
